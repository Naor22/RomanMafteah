...
python %PROJECT_NAME%\code\backend\core\manage.py collectstatic --no-input --clear
xcopy %PROJECT_NAME%\code\backend\core\static output\%PROJECT_NAME%\static\static\ /eqv
